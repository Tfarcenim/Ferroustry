...
public class ResourceTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
  private final BlockState log;
  private final BlockState leaf;
  private final boolean useExtraRandomHeight;

  public ResourceTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, boolean extraRandomHeightIn,
                             Block log, Block leaf, Block sapling) {
    super(configIn, doBlockNotifyIn);
    this.useExtraRandomHeight = extraRandomHeightIn;
    this.log = log.getDefaultState();
    this.leaf = leaf.getDefaultState();
